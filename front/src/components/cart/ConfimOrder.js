...
const ConfimOrder = () => {
    ...
    const precioImpuesto = Number((0.0 * precioItems).toFixed(2))
      ...
      <div className="row d-flex justify-content-between">
            ...
            <Fragment>
              ...
              <div className="cart-item my-1" key={item.product}>
                <div className="row">
                  ...
                  <div className="col-4 col-lg-6 mt- mt-lg-0">
                    <p>
                      {item.quantity} x ${item.precio} ={" "}
                      <b>${(item.quantity * item.precio).toFixed(2)}</b>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="col-12 col-lg-4 my-4">
          <div id="order_summary">
            ...
            <p>
              Subtotal:{" "}
              <span className="order-summary-values">${precioItems}</span>
            </p>
            <p>
              Costo de Envío:{" "}
            ...
            <p>
              Impuestos:{" "}
              <span className="order-summary-values">${precioImpuesto}</span>
            </p>
            ...
            <p>
              Total:{" "}
              <span className="order-summary-values">${precioTotal}</span>
            </p>
