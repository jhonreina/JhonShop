...
const Home = () => {
  return (
    <Fragment>
      <h1 id="encabezado_productos" className='encabezado text-center'>Ultimos Productos</h1>
      <section id="productos" className="container mt-2">
        <div className="row">
            {/* producto 1 */}
          <div className="col-12 col-md-6 col-lg-3 my-2">
            <div className="card p-3 rounded badge text-center">
              <img
              ...
              <div className="card-body d-flex  flex-column p-0 mt-1">
                    ...
                    <span id="no_de_opiniones" className='text-left'> 5 reviews</span>
                    </div>
                    <p className="card-text m-0 my-2 text-left">$180.000</p>
                    <a href="http:/3000/home" id="view_btn" className="btn btn-block">
                    Ver detalle 
                    </a>
              </div>
            </div>
          ...
          <div className="col-12 col-md-6 col-lg-3 my-2">
            <div className="card p-3 rounded badge text-center">
              ...
              <div className="card-body d-flex  flex-column p-0 mt-1   ">
                    ...
                    <a href="https:/3000/home" id="view_btn" className="btn btn-block">
                    Ver detalle 
                    </a>
              </div>
            </div>
